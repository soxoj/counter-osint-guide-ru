...
В отличие от большого количества гайдов по анонимности в Сети, здесь не будет зубодробительных советов использовать приватные прокси, создавать фейковые личности и подменять отпечатки браузера.
